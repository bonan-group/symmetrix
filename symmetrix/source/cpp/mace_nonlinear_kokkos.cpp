...
void bind_mace_nonlinear_kokkos(py::module_& module)
{
    py::class_<MaceNonlinearKokkos>(module,"MACENonlinearKokkos")
        ...
        .def_property_readonly("uses_mh1_fast_path",&MaceNonlinearKokkos::uses_mh1_fast_path)
        .def_property_readonly("supports_streamed_edges",&MaceNonlinearKokkos::supports_streamed_edges)
        .def_property_readonly("streamed_edges_mode",&MaceNonlinearKokkos::streamed_edges_mode)
        .def("set_streamed_edges",&MaceNonlinearKokkos::set_streamed_edges)
        .def_property_readonly("edge_workspace_rows",&MaceNonlinearKokkos::edge_workspace_rows)
        .def_property_readonly("edge_workspace_bytes",&MaceNonlinearKokkos::edge_workspace_bytes)
